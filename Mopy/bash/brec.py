...
class MreHeaderBase(MelRecord):
    ...
    __slots__ = [] # inherits also MelRecord.__slots__ which is a list
...
class MreGlob(MelRecord):
    ...
    __slots__ = melSet.getSlotsUsed() # inherits also MelRecord.__slots__
...
class MreLeveledListBase(MelRecord):
    ...
    copyAttrs = ()
    # in addition to MelRecord.__slots__
