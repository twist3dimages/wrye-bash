...
class _LineLayout(_Layout):
    ...
    def __init__(self, sizer, border=0, spacing=0,
        ...
        super(_LineLayout, self).__init__(sizer, border=border,
    ...
    def add(self, item):
        ...
        item, options, border, flags = super(_LineLayout, self)._get_item_options(item)
...
class HBoxedLayout(_LineLayout):
